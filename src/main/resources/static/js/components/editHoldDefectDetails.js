System.register(["vue", "vue-class-component", "bootstrap-vue", "/vue-templates/hold/holdDefectDetails.html", "../domain/hold/HoldTicket", "../domain/hold/Defect", "../services/holdTicketService"], function (exports_1, context_1) {
    "use strict";
    ...
    var vue_1, vue_class_component_1, bootstrap_vue_1, holdDefectDetails_html_1, HoldTicket_1, Defect_1, holdTicketService_1, EditHoldDefectDetails;
                ...
                EditHoldDefectDetails.prototype.mounted = function () {
                    ...
                    holdTicketService_1.default.getDefects().then(function (data) {
                        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                            ...
                            var tempDefect = new Defect_1.default(defect);
                            _this.defects.push(tempDefect);
                        }
                    });
                };
