System.register(["vue", "vue-class-component", "./holdTicketDetail", "../services/holdTicketService", "bootstrap-vue", "/vue-templates/hold/holdtickettable.html", "../domain/hold/HoldTicket"], function (exports_1, context_1) {
    "use strict";
            ...
            HoldTicketTable = /** @class */ (function (_super) {
                ...
                HoldTicketTable.prototype.mounted = function () {
                    ...
                    holdTicketService_1.default.getHoldTickets().then(function (data) {
                        ...
                        for (var _i = 0, _a = _this.returnData; _i < _a.length; _i++) {
                            var ticket = _a[_i];
                    ...
                    this.fields = [
                        ...
                        { key: 'actions', label: 'Edit/Action Tracking' }
                    ];
                    this.currentPage = 1;
                    this.perPage = 15;
